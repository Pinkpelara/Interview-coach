    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Manage each role you are preparing for.</p>
        </div>
      ...
      {applications.length === 0 ? (
        <Card>
          <CardContent className="py-16 text-center">
            <div className="w-14 h-14 rounded-full bg-[#5b5fc7]/20 flex items-center justify-center mx-auto mb-4">
              <Briefcase className="h-7 w-7 text-[#5b5fc7]" />
            </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {applications.map((app) => (
            <Card key={app.id} className="hover:bg-[#333] transition-colors">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="min-w-0">
                    <h3 className="font-semibold text-white truncate">{app.companyName}</h3>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <Link href={`/applications/${app.id}`} className="text-[#5b5fc7] font-medium inline-flex items-center gap-1">
